...
def create_rebop_running_time_data_oregonator(fn: str, min_pop_exponent: int, max_pop_exponent: int, end_time: float):
    ...
    for pop_exponent in range(min_pop_exponent, max_pop_exponent + 1):
        ...
        crn.add_reaction(1000 * (.1 ** pop_exponent), ['X2', 'X1'], [])
...
def plot_results(fn_rebop_data: str, fn_rebop_rust_data: str, fn_batss_data_f64: str, fn_batss_data_f128: str, fn_out: str):
    # figsize = (6,4)
    figsize = (5,4)
...
def plot_rebop_batss_histogram(pop_exponent: int, trials_exponent: int, species: str, final_time: float):
    ...
    ax.hist([batss_counts, rebop_counts], # type: ignore
            bins = 20,
...
def main():
    ...
    plot_results('data/oregonator_time1_times_rebop2.json', 
