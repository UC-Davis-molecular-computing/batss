...
fn main() {
    // println!("Running Oregonator model with rebop to test runtime sampling.");
    // let mut crn = Oregonator::new();
    // crn.seed(1);
    // let mut elapsed_times = vec![];
    // for pop_exponent in 3..=11 {
    //     println!("Running Oregonator with rebop with n=10^{pop_exponent}");

    //     let n = 10isize.pow(pop_exponent);
    //     crn.rate1 = 0.1;
    //     crn.rate2 = 1000.0 / n as f64;
    //     crn.rate3 = 520.0;
    //     crn.rate4 = 40.0 / n as f64;
    //     crn.rate5 = 443.324;
    //     crn.rate6 = 2.676;
    //     crn.X1 = n / 3;
    //     crn.X2 = n / 3;
    ...
    //     let filename = format!("data/oregonator_time1_times_rebop_rust.json");
    ...
    //     println!(
    //         "{elapsed} seconds to run Oregonator with rebop to time {end_time} with n=10^{pop_exponent}"
    //     );
